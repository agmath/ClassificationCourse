...
Put another way, if we had 10,000 observations, the expected number of observations falling into the interval of width $0.1$ corresponding to `X1` is 1,000. In the two variable case, the number of observations expected to fall into a square region in the two variable case with side length of $0.1$ is 100. In the three-variable case, the cube is expected to contain 10 observations. Once we move to four variables there is only one observation expected and five or more variables no observations are expected.
