...
Now that you know a bit more about Quarto and inline R code, find some opportunities to use inline R to automate bits of your discussion. This way, if the data set is updated you won't need to make manual changes.
