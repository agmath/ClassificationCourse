...
5. Inside of the *Pages* menu, under the **Build and deployment** heading, choose `Deploy from a branch* underneathe the *Source* option. Under *Branch*, choose `main` and it will default to `/(root)` which is perfect
