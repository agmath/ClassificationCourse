...
**Purpose:** In this notebook, we'll see that `{reticulate}` is more than just a package that allows you to work with Python inside of RStudio. This package allows for users and teams to mix Python and R code in a single document, passing objects back and forth between environments.

## Dual-Weilding Languages
