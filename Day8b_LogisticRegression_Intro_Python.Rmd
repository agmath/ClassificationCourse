...
You can see the full `{sklearn}` documentation for `LogisticRegression()` [here](https://scikit-learn.org/stable/modules/generated/sklearn.linear_model.LogisticRegression.html).
