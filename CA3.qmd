...
5. Use your model to make predictions for the properties in `comp.csv` (you'll need to read in that data first). Submit those predictions to our class Kaggle competition for scoring.
