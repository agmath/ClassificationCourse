...
I'd encourage you to use R functionality here for your exploratory work, but then switch back to `{sklearn}` and include text steps in your feature engineering `Pipeline()`s when it is time to build models. More on this towards the end of the notebook.
