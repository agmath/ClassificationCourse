...
You can see the full `{parsnip}` documentation for `svm_linear()` [here](https://parsnip.tidymodels.org/reference/svm_linear.html), for `svm_poly()` [here](https://parsnip.tidymodels.org/reference/svm_poly.html), and for `svm_rbf()` [here](https://parsnip.tidymodels.org/reference/svm_rbf.html).
